...
ruta_entrada = "C:/Users/Camilo A. Marin Cast/Downloads/Codigos_rosalind/rosalind_subs.txt"
ruta_salida = "C:/Users/Camilo A. Marin Cast/Downloads/Codigos_rosalind/rosalind_splc_result.txt"

with open (ruta_entrada, "r") as archivo_entrada:
    secuencia_adn = archivo_entrada.read().strip().splitlines()

# Se guardan SOLO las líneas de secuencia (las que NO comienzan con ">") en una lista
secuencias = []
for secuencia_adn in secuencia_adn:
    if not secuencia_adn.startswith(">"):
        secuencias.append(secuencia_adn)
...
print(f"Total de proteinas traducidas: {len(proteina)}")